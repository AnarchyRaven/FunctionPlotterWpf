...
namespace ProjectThickLines.ViewModels
{
    ...
    public class FunctionListVM
    {
        ...
        private void CalculateBiggestYANDSmallestY()
        {
            ...
            try
            {
                this.ChangeYMaxValue(new IntValueEventArgs(yMAX, XYAxisEnum.BigestYValue));
                this.ChangeYMinValue(new IntValueEventArgs(yMin, XYAxisEnum.BigestYValue));
            }
            catch (Exception)
            {
                this.ChangeYMaxValue(new IntValueEventArgs(10, XYAxisEnum.BigestYValue));
                this.ChangeYMinValue(new IntValueEventArgs(-8, XYAxisEnum.BigestYValue));
            }
        }
    }
}
